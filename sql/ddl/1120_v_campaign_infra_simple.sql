-- @gate: add
-- Depends on 1071 (core.campaign_infra), 1103 (core.campaign_offer_scope), 1079
-- ============================================================================
-- 1120_v_campaign_infra_simple.sql [2026-07-17] — Sam ruling R32, 2026-07-16/17
...
SELECT campaign_id,
       ...
       END AS infra,
       CASE
           WHEN infra_vendor IN ('OTD','Reseller','MilkBox') THEN
