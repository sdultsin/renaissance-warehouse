...
CREATE TABLE IF NOT EXISTS core.cost_ledger (
  ...
  vendor              VARCHAR NOT NULL,       -- short vendor identifier (free-form; loaded from external seed)
  sku                 VARCHAR,                -- vendor item identifier (e.g. subscription / renewal / monthly unit)
  ...
  attribution_id      VARCHAR,                -- workspace_id / offer / channel / domain / inbox email; NULL for global
