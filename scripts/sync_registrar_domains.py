...
def main(argv=None) -> int:
    ...
    if "registrar_account" not in cols:
        raise SystemExit(f"cache {have[0]} is the OLD 4-col shape (cols={cols}); "
                         "re-run backfill_purchased_at_registrars.py --refresh-cache with the enriched writer first")
